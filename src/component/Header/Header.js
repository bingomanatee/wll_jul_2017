...
const HeaderDirNav = (props) => (
  <div className={`HeaderDirNav__item ${props.active ? 'HeaderDirNav__item-active' : ''}`}
       onClick={() => Actions.goDirectory(cleanDirectory(props.directory.directory))}
...
export default (props) => (<div>
    ...
    <div className="HeaderDirNav dark" style={navStyle(props)}>
      ...
      {props.directories.map((directory, i) => <HeaderDirNav
        active={cleanDirectory(directory.directory) === cleanDirectory(props.currentDir)}
